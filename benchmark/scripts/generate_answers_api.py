...
def main():
    ...
    print(f"Generating answers for {total} questions using the running RAG API...")
    ...
    for i, q in enumerate(questions):
        ...
        try:
            # We query the actual running uvicorn server
            ...
            answer = f"Exception generating answer: {e}"
            sources = []
